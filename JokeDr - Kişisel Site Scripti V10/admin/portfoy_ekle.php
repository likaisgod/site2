...
<?php include('dahil/php/menu.php'); ?>
				<div class="span9 content">
					...
					<div class="well">
						...
						<br />
	<form name="Duzenle" id="durum" method="post" class="form-horizontal" enctype="multipart/form-data" action="dahil/modul/portfoy/portfoy_ekle_ok.php">   
		...
		<div class="controls"><img class="avatar" src="../dahil/portfoy/portfoy.jpg" alt="user" />
