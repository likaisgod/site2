...
<?php include('dahil/php/menu.php'); ?>
				<div class="span9 content">
					<div class="banner">
						<h2><? echo "$menul_014";?></h2>
						<p><? echo "$vcard_001";?></p>
					</div>
					<h3><? echo "$menul_014";?>:</h3>
					<div class="well">
						<strong><? echo "$vcard_001";?>:</strong>
<form name="Duzenle" id="durum" method="post" class="form-horizontal" enctype="multipart/form-data" action="dahil/modul/digeri/vcard_ok.php">   
		<hr />
		<div class="control-group"><label class="control-label" for="user-avatar"><? echo "$menul_014";?></label>
		<div class="controls">
		</div><div class="controls"><input type="file" name="vcard" /></div></div>
