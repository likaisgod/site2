...
<?php $TW1 = mysql_query("select * from zcard_twitter where No in ('1')"); $TW = mysql_fetch_assoc($TW1);?>
					...
					<div class="well">
						...
						<br />
					<ul class="pager"><li class="next"><a class="btn-success" href="begeni_ekle.php"><? echo "$menul_008";?> <? echo "$buton_004";?> &rarr;</a></li></ul>
					
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="optional"><? echo "$begen_002";?></th>
								<th><? echo "$begen_003";?></th>
								<th class="optional"><? echo "$begen_004";?></th>
								<th><? echo "$buton_007";?></th>
							</tr>
						</thead>
						<tbody>
<?php
$sql=mysql_query("select * from zcard_egitim_begeniler ORDER BY No");
while($oku=mysql_fetch_array($sql))
{
  ...
  echo '
							...
							<ul class="dropdown-menu">
								<li>
								<a href="begeni_duzenle.php?veridetay='.$A1.'">'; ?><? echo "$buton_005";?></a><? echo '
								<li>
								<a href="begeni_sil.php?veridetay='.$A1.'">'; ?><? echo "$buton_006";?></a><? echo '
								</li>
							</ul>
						</div>
                          </td></tr>';
