...
<?php $TW1 = mysql_query("select * from zcard_twitter where No in ('1')"); $TW = mysql_fetch_assoc($TW1);?>
					<div class="banner">
					...
					<div class="well">
						...
						<br />
					<ul class="pager"><li class="next"><a class="btn-success" href="beceri_ekle.php"><? echo "$menul_008";?> <? echo "$buton_004";?> &rarr;</a></li></ul>
					
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="optional"><? echo "$becer_002";?></th>
								<th class="optional"><? echo "$becer_003";?></th>
								<th class="optional"><? echo "$buton_007";?></th>
							</tr>
						</thead>
						<tbody>
<?php
$sql=mysql_query("select * from zcard_deneyim_beceri ORDER BY No");
while($oku=mysql_fetch_array($sql))
{
  ...
  echo '
							...
							<ul class="dropdown-menu">
								<li>
								<a href="beceri_duzenle.php?veridetay='.$A1.'">'; ?><? echo "$buton_005";?></a><? echo '
								<li>
								<a href="beceri_sil.php?veridetay='.$A1.'">'; ?><? echo "$buton_006";?></a><? echo '
								</li>
							</ul>
						</div>
                          </td></tr>';
