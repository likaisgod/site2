...
<?php include('dahil/php/menu.php'); ?>
				<div class="span9 content">
					...
					<div class="well">
						...
						<ul class="pager"><li class="next"><a class="btn-success" href="portfoy_ekle.php"><? echo "$menul_005";?> <? echo "$buton_004";?> &rarr;</a></li></ul>
						<br />
					
					<ul class="thumbnails">
					<?php
$sql=mysql_query("select * from zcard_portfoy");
while($oku=mysql_fetch_array($sql))
{
  ...
  echo '
						<li class="span3">
							<div class="thumbnail">
								<img width="225" height="125" src="../dahil/portfoy/'.$A3.'" alt="'.$A2.'" />
								<p class="item-actions">
									<a href="portfoy_duzenle.php?portfoydetay='.$A1.'"><i class="icon icon-edit"></i></a>
									<a href="portfoy_sil.php?portfoydetay='.$A1.'"><i class="icon icon-remove"></i></a>
								</p>
								<h5>'.$A2.'</h5>
							</div>
						</li>
