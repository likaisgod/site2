...
<?php $TW1 = mysql_query("select * from zcard_twitter where No in ('1')"); $TW = mysql_fetch_assoc($TW1);?>
					...
					<div class="well">
						...
						<br />
					<ul class="pager"><li class="next"><a class="btn-success" href="egitim_ekle.php"><? echo "$menul_007";?> <? echo "$buton_004";?> &rarr;</a></li></ul>
					
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="optional"><? echo "$egiti_003";?></th>
								<th><? echo "$egiti_004";?></th>
								<th class="optional"><? echo "$egiti_005";?></th>
								<th class="optional"><? echo "$egiti_006";?></th>
								<th><? echo "$buton_007";?></th>
							</tr>
						</thead>
						<tbody>
<?php
$sql=mysql_query("select * from zcard_egitim ORDER BY No");
while($oku=mysql_fetch_array($sql))
{
  ...
  echo '
							...
							<ul class="dropdown-menu">
								<li>
								<a href="egitim_duzenle.php?veridetay='.$A1.'">'; ?><? echo "$buton_005";?></a><? echo '
								<li>
								<a href="egitim_sil.php?veridetay='.$A1.'">'; ?><? echo "$buton_006";?></a><? echo '
								</li>
							</ul>
						</div>
                          </td></tr>';
