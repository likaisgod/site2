...
<?php $sql=mysql_query("select * from zcard_deneyim ORDER BY No DESC LIMIT 1");while($oku=mysql_fetch_array($sql)){$DK= $oku['No'];} ?>
<?php ob_start(); ?>
<?php
	$A1		= $DK+1;
	$A2		= $_POST['Yil'];
...
$Komut=mysql_query("insert into zcard_deneyim values('$A1','$A2','$A3','$A4','$A5')");
	if($Komut){ ?>
	...
	<? } ?>
<?php ob_end_flush(); ?>    
<meta http-equiv="refresh" content="2;URL=deneyim.php"></p>