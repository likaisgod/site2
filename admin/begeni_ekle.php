...
<?php include('dahil/php/menu.php'); ?>
				<div class="span9 content">
					...
					<div class="well">
						...
						<br />
	<form name="Duzenle" id="durum" method="post" class="form-horizontal" enctype="multipart/form-data" action="dahil/modul/begeni/begeni_ekle_ok.php">   
		<div class="control-group"><label class="control-label" for="Baslik"><? echo "$begen_002";?></label>
		<div class="controls"><input type="text" name="Baslik" id="Baslik" value="" /></div></div>
		<div class="control-group"><label class="control-label" for="Web"><? echo "$begen_004";?></label>
		<div class="controls"><input type="text" name="Web" id="Web" value="" /></div></div>
		<div class="control-group"><label class="control-label" for="Aciklama"><? echo "$begen_003";?></label>
		<div class="controls"><textarea class="ckeditor" rows="4" name="Aciklama" id="Aciklama" placeholder=""></textarea></div></div>
