...
<?php $NO=$_GET["veridetay"]; $EG1 = mysql_query("select * from zcard_deneyim where No='$NO'"); $EG = mysql_fetch_assoc($EG1);?>
					<div class="banner">
					...
					<div class="well">
						...
						<br />
	<? echo '<form name="Duzenle" id="durum" method="post" class="form-horizontal" enctype="multipart/form-data" action="dahil/modul/deneyim/deneyim_duzenle_ok.php?veridetay='.$NO.'">';?>
