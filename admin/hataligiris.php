		...
		<div class="container wrapper">
			<div class="row">
				...
				<div class="span4 offset4 well">
					...
					<hr /><center>
					<h3><font color="#FF0000"><b><? echo "$yetki_003";?></b></font></h3><hr />
					<b><? echo "$hatali_001";?></b><hr/>
<a href="javascript:history.back(-1)" type="button" class="btn btn-success"><? echo "$hatali_002";?></a></center>
				</div>
			</div>
			<hr />
