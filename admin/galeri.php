...
<?php include('dahil/php/menu.php'); ?>
				<div class="span9 content">
					...
					<div class="banner">
						<h2>Fancy Items Gallery</h2>
						<p>There are some good news for you today to find out.</p>
					</div>

					<h3>Store your items, pictures or documents:</h3>

					<ul class="thumbnails">
						<li class="span3">
							<div class="thumbnail">
								<img src="dahil/resim/item-4.png" alt="" />
								<p class="item-actions">
									<a href="#"><i class="icon icon-save"></i></a>
									<a href="#"><i class="icon icon-print"></i></a>
						...
						<li class="span3">
							<div class="thumbnail">
								<img src="dahil/resim/item-5.png" alt="" />
								<p class="item-actions">
									<a href="#"><i class="icon icon-save"></i></a>
									<a href="#"><i class="icon icon-print"></i></a>
									<a href="#"><i class="icon icon-link"></i></a>
						...
						<li class="span3">
							<div class="thumbnail">
								<img src="dahil/resim/item-6.png" alt="" />
								<p class="item-actions">
									<a href="#"><i class="icon icon-save"></i></a>
									<a href="#"><i class="icon icon-print"></i></a>
									<a href="#"><i class="icon icon-link"></i></a>
					...
					<div class="row-fluid marketing">
						<div class="span3">
							<a href="#"><img src="dahil/resim/mini-banner-1.png" alt="ad" /></a>
						</div>
						<div class="span3">
							<a href="#"><img src="dahil/resim/mini-banner-2.png" alt="ad" /></a>
						</div>
						<div class="span3">
							<a href="#"><img src="dahil/resim/mini-banner-3.png" alt="ad" /></a>
						</div>
						<div class="span3">
							<a href="#"><img src="dahil/resim/mini-banner-4.png" alt="ad" /></a>
						</div>
					</div>
